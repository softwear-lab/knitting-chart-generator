...
const TRANSLATIONS = {
  en: {
    ...
    'step-upload-title': 'Import Photo',
    'dropzone-primary-text': 'Upload Photo',
    'dropzone-secondary-text': 'Drag & Drop or click to browse',
    'btn-change-file': 'Change',
    'step-stitch-title': 'Image Prep & Grid',
    ...
    'btn-tab-original': 'Original Image',
    'btn-tab-chart': 'Knitting Chart',
    'preview-grid-title': 'Stitch Preview Grid',
    'canvas-placeholder': 'Knitting chart preview',
  ...
  pl: {
    ...
    'step-upload-title': 'Import zdjęcia',
    'dropzone-primary-text': 'Wgraj zdjęcie',
    'dropzone-secondary-text': 'Przeciągnij i upuść lub kliknij',
    'btn-change-file': 'Zmień',
    'step-stitch-title': 'Przygotowanie obrazu i siatka',
    ...
    'btn-tab-original': 'Oryginalny obraz',
    'btn-tab-chart': 'Schemat wzoru',
    'preview-grid-title': 'Podgląd siatki oczek',
    'canvas-placeholder': 'Podgląd schematu dziewiarskiego',
